...
for filename in filenames:
	temp_stat_one_gun = pd.read_csv('bb_' + filename, names=columns_one_gun, skiprows=onegunskip, delim_whitespace=True, nrows=twogunskip-onegunskip)
	temp_stat_one_gun['filename'] = filename
	stat_one_gun = stat_one_gun.append(temp_stat_one_gun)
	temp_stat_one_gun = []
	
	temp_stat_two_gun = pd.read_csv('bb_' + filename, names=columns_two_gun, skiprows=twogunskip, delim_whitespace=True, nrows=spareskip-twogunskip)
	temp_stat_two_gun['filename'] = filename
	stat_two_gun = stat_two_gun.append(temp_stat_two_gun)
	temp_stat_two_gun = []
	
	temp_stat_spare_gun = pd.read_csv('bb_' + filename, names=columns_spare_gun, skiprows=spareskip, delim_whitespace=True, nrows=eof-spareskip)
	temp_stat_spare_gun['filename'] = filename
	stat_spare_gun = stat_spare_gun.append(temp_stat_spare_gun)
	temp_stat_spare_gun = []
	
	temp_stat_one_gun_cc = pd.read_csv('cc_' + filename, names=columns_one_gun_cc, skiprows=onegunskipcc, delim_whitespace=True, nrows=twogunskipcc-onegunskipcc)
	temp_stat_one_gun_cc['filename'] = filename
	stat_one_gun_cc = stat_one_gun_cc.append(temp_stat_one_gun_cc)
	temp_stat_one_gun_cc = []
	
	temp_stat_two_gun_cc = pd.read_csv('cc_' + filename, names=columns_two_gun_cc, skiprows=twogunskipcc, delim_whitespace=True, nrows=spareskipcc-twogunskipcc)
	temp_stat_two_gun_cc['filename'] = filename
	stat_two_gun_cc = stat_two_gun_cc.append(temp_stat_two_gun_cc)
	temp_stat_two_gun_cc = []
	
	temp_stat_spare_gun_cc = pd.read_csv('cc_' + filename, names=columns_spare_gun_cc, skiprows=spareskipcc, delim_whitespace=True, nrows=eofcc-spareskipcc)
	temp_stat_spare_gun_cc['filename'] = filename
	stat_spare_gun_cc = stat_spare_gun_cc.append(temp_stat_spare_gun_cc)
	temp_stat_spare_gun_cc = []
	

#print('stat_one_gun: ')
#print(stat_one_gun.head())
# print(stat_one_gun.tail())
# print(stat_one_gun)
# print('temp_stat_one_gun: ')
# print(temp_stat_one_gun)
#print('stat_two_gun: ')
...
#print(stat_spare_gun_all.sort_values('MaxPhase').tail(70).to_string(index=False))
#print(stat_spare_gun_cc_all.loc[stat_spare_gun_cc_all['filename'] == '4130T__090_2000_080_5.dan'].to_string(index=False))
#print(stat_one_gun_all.loc[stat_one_gun_all['filename'] == '4130T__090_2000_080_5.dan'].to_string(index=False))
